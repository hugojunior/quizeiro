...
<body>
	<div id="container">
        <div class="archived">
            <ion-icon name="archive-outline" class="ic"></ion-icon>
            <h2>Este quiz não está mais aceitando respostas!</h2>
            <h3>Encerrou em: <span>{{ $quiz->date_end->format('d/m/Y \à\s H:i') }}</span></h3>
        </div>
